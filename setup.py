...
setup(
    ...
    entry_points={
        "console_scripts": [
            "gasw=insar.scripts.process_gamma:run",
    ...
    keywords="insar gamma ga_sar_workflow",
    name="ga_sar_workflow",
    packages=find_packages(exclude=("tests", "tests.*")),
    package_data={"": ["*.json", "*.yaml", "logging.cfg"]},
    setup_requires=setup_requirements,
    test_suite="tests",
    tests_require=test_requirements,
    url="https://github.com/GeoscienceAustralia/ga_sar_workflow",
